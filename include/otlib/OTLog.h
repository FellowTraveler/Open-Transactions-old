...
* This class has a member variable for the location
* of the log-file, and a string for the 'thread context.'
* Otherwise it doesn’t care about anything else.
*
* You cannot make a direct instance of this class.
* Rather, this class has static functions that internally
* calls It(), that returns a thread-local context.
*
* OTLog will throw an exception if the static function:
*
* bool Init(
*			const OTString & strThreadContext,
*			const OTString & strLogFilePath,
*			const int & nLogLevel
*			);
*
* isn't called beforehand.
*
* However the API should automatically call that for you.
* So any higher level developers don't need to deal with it.
* 
*/
...
EXPORT typedef std::deque<std::unique_ptr<OTString>> dequeOfStrings;
...
#define thread_local
#endif
	static thread_local OTLog * pLogger;
