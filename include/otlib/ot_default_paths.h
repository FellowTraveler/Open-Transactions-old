 ...
 *  ot_default_paths.h
 *  
 *  Just keeping it all in one place :-)
 */
...
#ifndef __OT_DEFAULT_PATHS_H__
#define __OT_DEFAULT_PATHS_H__
// ---------------------------------------------------------------------------
...
#define OT_OPTIONS_FILE_DEFAULT	"command-line-ot.opt"  // this one is used by server also.
...
// Paths
//
#define SERVER_INI_FILE_DEFAULT	".ot/ot_init.cfg"  // should get programmatically
#define SERVER_PATH_DEFAULT	".ot/server_data" // should get programmatically

// -----------------------------------------------

#ifdef _WIN32
#define OT_DEFAULT_PATH_SEPARATOR	"\\"
#else
#define OT_DEFAULT_PATH_SEPARATOR	"/"
#endif
