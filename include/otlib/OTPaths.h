...
#define thread_local
#endif
	static thread_local OTDataFolder * pDataFolder;
...
public:
	...
	EXPORT static const OTString & GetConfigFilePath();
};
...
static inline const bool GetSetFolderName(const std::unique_ptr<OTSettings> & pConfig, const std::string strKeyName, const std::string strDefaultName, OTString & ret_strName)
{
