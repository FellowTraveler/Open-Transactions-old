...
public:
	...
	/* LINKS TO STRINGS
	 *
	 * These use the symbols ``0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'' to
	 * represent digits of 0 through 61.  When parsing strings, lowercase is
	 * also accepted.
	 *
