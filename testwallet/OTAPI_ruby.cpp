...
_wrap_OT_API_Mint_IsStillGood(int argc, VALUE *argv, VALUE self) {
  ...
  res3 = SWIG_AsCharPtrAndSize(argv[2], &buf3, NULL, &alloc3);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "char const *","OT_API_Mint_IsStillGood", 3, argv[2] ));
  }
  arg3 = reinterpret_cast< char * >(buf3);
...
swig_class SwigClassRippleServer;
...
swig_class SwigClassLoomServer;
