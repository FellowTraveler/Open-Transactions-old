accept_inbox.ot*            Willy-nilly accepts ALL receipts currently in the inbox.
...
create_nym.ot*              Create a new Pseudonym, aka Key Pair
...
issue_asset.ot*             Issue a new asset type onto an OT server.
