...
class OTAPI_Basic {
	...
	static function Encode($strPlalongext,$bLineBreaks) {
		return OTAPI_Basic_Encode($strPlalongext,$bLineBreaks);
	}
	...
	static function Ledger_GetTransactionNumberByIndex($SERVER_ID,$USER_ID,$ACCOUNT_ID,$THE_LEDGER,$nIndex) {
		return OTAPI_Basic_Ledger_GetTransactionNumberByIndex($SERVER_ID,$USER_ID,$ACCOUNT_ID,$THE_LEDGER,$nIndex);
	}
	...
	static function CreatePurse($SERVER_ID,$ASSET_TYPE_ID,$USER_ID) {
		return OTAPI_Basic_CreatePurse($SERVER_ID,$ASSET_TYPE_ID,$USER_ID);
	}
	...
	static function Purse_Peek($SERVER_ID,$ASSET_TYPE_ID,$USER_ID,$THE_PURSE) {
		return OTAPI_Basic_Purse_Peek($SERVER_ID,$ASSET_TYPE_ID,$USER_ID,$THE_PURSE);
	}

	static function Purse_Pop($SERVER_ID,$ASSET_TYPE_ID,$USER_ID,$THE_PURSE) {
		return OTAPI_Basic_Purse_Pop($SERVER_ID,$ASSET_TYPE_ID,$USER_ID,$THE_PURSE);
	}

	static function Purse_Push($SERVER_ID,$ASSET_TYPE_ID,$USER_ID,$THE_PURSE,$THE_TOKEN) {
		return OTAPI_Basic_Purse_Push($SERVER_ID,$ASSET_TYPE_ID,$USER_ID,$THE_PURSE,$THE_TOKEN);
	}
	...
	static function Token_ChangeOwner($SERVER_ID,$ASSET_TYPE_ID,$THE_TOKEN,$OLD_OWNER_NYM_ID,$NEW_OWNER_NYM_ID) {
		return OTAPI_Basic_Token_ChangeOwner($SERVER_ID,$ASSET_TYPE_ID,$THE_TOKEN,$OLD_OWNER_NYM_ID,$NEW_OWNER_NYM_ID);
	}
	...
	static function Instrument_GetAmount($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrument_GetAmount($SERVER_ID,$THE_INSTRUMENT);
	}

	static function Instrument_GetTransNum($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrument_GetTransNum($SERVER_ID,$THE_INSTRUMENT);
	}

	static function Instrument_GetValidFrom($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrument_GetValidFrom($SERVER_ID,$THE_INSTRUMENT);
	}

	static function Instrument_GetValidTo($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrument_GetValidTo($SERVER_ID,$THE_INSTRUMENT);
	}

	static function Instrument_GetMemo($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrument_GetMemo($SERVER_ID,$THE_INSTRUMENT);
	}

	static function Instrument_GetType($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrument_GetType($SERVER_ID,$THE_INSTRUMENT);
	}

	static function Instrument_GetAssetID($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrument_GetAssetID($SERVER_ID,$THE_INSTRUMENT);
	}

	static function Instrmnt_GetSenderUserID($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrmnt_GetSenderUserID($SERVER_ID,$THE_INSTRUMENT);
	}

	static function Instrmnt_GetSenderAcctID($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrmnt_GetSenderAcctID($SERVER_ID,$THE_INSTRUMENT);
	}

	static function Instrmnt_GetRecipientUserID($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrmnt_GetRecipientUserID($SERVER_ID,$THE_INSTRUMENT);
	}

	static function Instrmnt_GetRecipientAcctID($SERVER_ID,$THE_INSTRUMENT) {
		return OTAPI_Basic_Instrmnt_GetRecipientAcctID($SERVER_ID,$THE_INSTRUMENT);
	}
