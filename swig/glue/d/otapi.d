...
class OTAPI_Basic {
  ...
  public static char[] Encode(char[] strPlalongext, bool bLineBreaks) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Encode((strPlalongext ? tango.stdc.stringz.toStringz(strPlalongext) : null), bLineBreaks));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }
  ...
  public static bool AddServerContract(char[] strContract) {
    bool ret = otapi_im.OTAPI_Basic_AddServerContract((strContract ? tango.stdc.stringz.toStringz(strContract) : null)) ? true : false;
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static bool AddAssetContract(char[] strContract) {
    bool ret = otapi_im.OTAPI_Basic_AddAssetContract((strContract ? tango.stdc.stringz.toStringz(strContract) : null)) ? true : false;
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }
  ...
  public static char[] LoadUserPubkey(char[] USER_ID) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_LoadUserPubkey((USER_ID ? tango.stdc.stringz.toStringz(USER_ID) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] LoadPubkey(char[] USER_ID) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_LoadPubkey((USER_ID ? tango.stdc.stringz.toStringz(USER_ID) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }
  ...
  public static char[] Ledger_GetTransactionNumberByIndex(char[] SERVER_ID, char[] USER_ID, char[] ACCOUNT_ID, char[] THE_LEDGER, tango.stdc.config.c_long nIndex) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Ledger_GetTransactionNumberByIndex((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (USER_ID ? tango.stdc.stringz.toStringz(USER_ID) : null), (ACCOUNT_ID ? tango.stdc.stringz.toStringz(ACCOUNT_ID) : null), (THE_LEDGER ? tango.stdc.stringz.toStringz(THE_LEDGER) : null), nIndex));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }
  ...
  public static char[] CreatePurse(char[] SERVER_ID, char[] ASSET_TYPE_ID, char[] USER_ID) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_CreatePurse((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (ASSET_TYPE_ID ? tango.stdc.stringz.toStringz(ASSET_TYPE_ID) : null), (USER_ID ? tango.stdc.stringz.toStringz(USER_ID) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }
  ...
  public static char[] Purse_Peek(char[] SERVER_ID, char[] ASSET_TYPE_ID, char[] USER_ID, char[] THE_PURSE) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Purse_Peek((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (ASSET_TYPE_ID ? tango.stdc.stringz.toStringz(ASSET_TYPE_ID) : null), (USER_ID ? tango.stdc.stringz.toStringz(USER_ID) : null), (THE_PURSE ? tango.stdc.stringz.toStringz(THE_PURSE) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Purse_Pop(char[] SERVER_ID, char[] ASSET_TYPE_ID, char[] USER_ID, char[] THE_PURSE) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Purse_Pop((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (ASSET_TYPE_ID ? tango.stdc.stringz.toStringz(ASSET_TYPE_ID) : null), (USER_ID ? tango.stdc.stringz.toStringz(USER_ID) : null), (THE_PURSE ? tango.stdc.stringz.toStringz(THE_PURSE) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Purse_Push(char[] SERVER_ID, char[] ASSET_TYPE_ID, char[] USER_ID, char[] THE_PURSE, char[] THE_TOKEN) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Purse_Push((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (ASSET_TYPE_ID ? tango.stdc.stringz.toStringz(ASSET_TYPE_ID) : null), (USER_ID ? tango.stdc.stringz.toStringz(USER_ID) : null), (THE_PURSE ? tango.stdc.stringz.toStringz(THE_PURSE) : null), (THE_TOKEN ? tango.stdc.stringz.toStringz(THE_TOKEN) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }
  ...
  public static char[] Token_ChangeOwner(char[] SERVER_ID, char[] ASSET_TYPE_ID, char[] THE_TOKEN, char[] OLD_OWNER_NYM_ID, char[] NEW_OWNER_NYM_ID) {
  ...
  public static char[] Instrument_GetAmount(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrument_GetAmount((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Instrument_GetTransNum(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrument_GetTransNum((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Instrument_GetValidFrom(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrument_GetValidFrom((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Instrument_GetValidTo(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrument_GetValidTo((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Instrument_GetMemo(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrument_GetMemo((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Instrument_GetType(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrument_GetType((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Instrument_GetAssetID(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrument_GetAssetID((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Instrmnt_GetSenderUserID(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrmnt_GetSenderUserID((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Instrmnt_GetSenderAcctID(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrmnt_GetSenderAcctID((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Instrmnt_GetRecipientUserID(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrmnt_GetRecipientUserID((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }

  public static char[] Instrmnt_GetRecipientAcctID(char[] SERVER_ID, char[] THE_INSTRUMENT) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Instrmnt_GetRecipientAcctID((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }
  ...
  public static tango.stdc.config.c_long sendUserInstrument(char[] SERVER_ID, char[] USER_ID, char[] USER_ID_RECIPIENT, char[] RECIPIENT_PUBKEY, char[] THE_INSTRUMENT) {
    auto ret = otapi_im.OTAPI_Basic_sendUserInstrument((SERVER_ID ? tango.stdc.stringz.toStringz(SERVER_ID) : null), (USER_ID ? tango.stdc.stringz.toStringz(USER_ID) : null), (USER_ID_RECIPIENT ? tango.stdc.stringz.toStringz(USER_ID_RECIPIENT) : null), (RECIPIENT_PUBKEY ? tango.stdc.stringz.toStringz(RECIPIENT_PUBKEY) : null), (THE_INSTRUMENT ? tango.stdc.stringz.toStringz(THE_INSTRUMENT) : null));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }
  ...
  public static char[] Message_GetDepth(char[] THE_MESSAGE) {
    char[] ret = tango.stdc.stringz.fromStringz(otapi_im.OTAPI_Basic_Message_GetDepth((THE_MESSAGE ? tango.stdc.stringz.toStringz(THE_MESSAGE) : null)));
    if (otapi_im.SwigPendingException.isPending) throw otapi_im.SwigPendingException.retrieve();
    return ret;
  }
