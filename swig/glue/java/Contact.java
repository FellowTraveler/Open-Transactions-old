...
public class Contact extends Displayable {
  ...
  public boolean RemoveContactNym(long nIndexContactNym) {
    return otapiJNI.Contact_RemoveContactNym(swigCPtr, this, nIndexContactNym);
  }
  ...
  public boolean RemoveContactAcct(long nIndexContactAcct) {
    return otapiJNI.Contact_RemoveContactAcct(swigCPtr, this, nIndexContactAcct);
  }
  ...
  public static Storable ot_dynamic_cast_box(Contact pUnboxed) {
    long cPtr = otapiJNI.Contact_ot_dynamic_cast_box(Contact.getCPtr(pUnboxed), pUnboxed);
