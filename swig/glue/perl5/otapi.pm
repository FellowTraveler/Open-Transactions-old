...
*OT_API_NumList_Add = *otapic::OT_API_NumList_Add;
*OT_API_NumList_Remove = *otapic::OT_API_NumList_Remove;
*OT_API_NumList_VerifyQuery = *otapic::OT_API_NumList_VerifyQuery;
*OT_API_NumList_VerifyAll = *otapic::OT_API_NumList_VerifyAll;
*OT_API_NumList_Count = *otapic::OT_API_NumList_Count;
...
*OT_API_Wallet_ChangePassphrase = *otapic::OT_API_Wallet_ChangePassphrase;
*OT_API_Wallet_ExportNym = *otapic::OT_API_Wallet_ExportNym;
*OT_API_Wallet_ImportNym = *otapic::OT_API_Wallet_ImportNym;
*OT_API_Wallet_ImportCert = *otapic::OT_API_Wallet_ImportCert;
*OT_API_Wallet_ExportCert = *otapic::OT_API_Wallet_ExportCert;
*OT_API_Wallet_GetNymIDFromPartial = *otapic::OT_API_Wallet_GetNymIDFromPartial;
*OT_API_Wallet_GetServerIDFromPartial = *otapic::OT_API_Wallet_GetServerIDFromPartial;
*OT_API_Wallet_GetAssetIDFromPartial = *otapic::OT_API_Wallet_GetAssetIDFromPartial;
*OT_API_Wallet_GetAccountIDFromPartial = *otapic::OT_API_Wallet_GetAccountIDFromPartial;
