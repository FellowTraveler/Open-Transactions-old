...
public class otapi {
  ...
  public static string OT_API_NumList_Add(string szNumList, string szNumbers) {
    string ret = otapiPINVOKE.OT_API_NumList_Add(szNumList, szNumbers);
    return ret;
  }

  public static string OT_API_NumList_Remove(string szNumList, string szNumbers) {
    string ret = otapiPINVOKE.OT_API_NumList_Remove(szNumList, szNumbers);
    return ret;
  }

  public static int OT_API_NumList_VerifyQuery(string szNumList, string szNumbers) {
    int ret = otapiPINVOKE.OT_API_NumList_VerifyQuery(szNumList, szNumbers);
    return ret;
  }

  public static int OT_API_NumList_VerifyAll(string szNumList, string szNumbers) {
    int ret = otapiPINVOKE.OT_API_NumList_VerifyAll(szNumList, szNumbers);
    return ret;
  }

  public static int OT_API_NumList_Count(string szNumList) {
    int ret = otapiPINVOKE.OT_API_NumList_Count(szNumList);
    return ret;
  }
  ...
  public static string OT_API_Wallet_GetNymIDFromPartial(string PARTIAL_ID) {
    string ret = otapiPINVOKE.OT_API_Wallet_GetNymIDFromPartial(PARTIAL_ID);
    return ret;
  }

  public static string OT_API_Wallet_GetServerIDFromPartial(string PARTIAL_ID) {
    string ret = otapiPINVOKE.OT_API_Wallet_GetServerIDFromPartial(PARTIAL_ID);
    return ret;
  }

  public static string OT_API_Wallet_GetAssetIDFromPartial(string PARTIAL_ID) {
    string ret = otapiPINVOKE.OT_API_Wallet_GetAssetIDFromPartial(PARTIAL_ID);
    return ret;
  }

  public static string OT_API_Wallet_GetAccountIDFromPartial(string PARTIAL_ID) {
    string ret = otapiPINVOKE.OT_API_Wallet_GetAccountIDFromPartial(PARTIAL_ID);
    return ret;
  }
