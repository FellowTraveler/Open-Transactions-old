...
public class OTAPI_Basic : IDisposable {
  ...
  public static string Encode(string strPlalongext, bool bLineBreaks) {
    string ret = otapiPINVOKE.OTAPI_Basic_Encode(strPlalongext, bLineBreaks);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static bool AddServerContract(string strContract) {
    bool ret = otapiPINVOKE.OTAPI_Basic_AddServerContract(strContract);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static bool AddAssetContract(string strContract) {
    bool ret = otapiPINVOKE.OTAPI_Basic_AddAssetContract(strContract);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static string Ledger_GetTransactionNumberByIndex(string SERVER_ID, string USER_ID, string ACCOUNT_ID, string THE_LEDGER, int nIndex) {
    string ret = otapiPINVOKE.OTAPI_Basic_Ledger_GetTransactionNumberByIndex(SERVER_ID, USER_ID, ACCOUNT_ID, THE_LEDGER, nIndex);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static string CreatePurse(string SERVER_ID, string ASSET_TYPE_ID, string USER_ID) {
    string ret = otapiPINVOKE.OTAPI_Basic_CreatePurse(SERVER_ID, ASSET_TYPE_ID, USER_ID);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static string Purse_Peek(string SERVER_ID, string ASSET_TYPE_ID, string USER_ID, string THE_PURSE) {
    string ret = otapiPINVOKE.OTAPI_Basic_Purse_Peek(SERVER_ID, ASSET_TYPE_ID, USER_ID, THE_PURSE);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Purse_Pop(string SERVER_ID, string ASSET_TYPE_ID, string USER_ID, string THE_PURSE) {
    string ret = otapiPINVOKE.OTAPI_Basic_Purse_Pop(SERVER_ID, ASSET_TYPE_ID, USER_ID, THE_PURSE);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Purse_Push(string SERVER_ID, string ASSET_TYPE_ID, string USER_ID, string THE_PURSE, string THE_TOKEN) {
    string ret = otapiPINVOKE.OTAPI_Basic_Purse_Push(SERVER_ID, ASSET_TYPE_ID, USER_ID, THE_PURSE, THE_TOKEN);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static string Token_ChangeOwner(string SERVER_ID, string ASSET_TYPE_ID, string THE_TOKEN, string OLD_OWNER_NYM_ID, string NEW_OWNER_NYM_ID) {
    string ret = otapiPINVOKE.OTAPI_Basic_Token_ChangeOwner(SERVER_ID, ASSET_TYPE_ID, THE_TOKEN, OLD_OWNER_NYM_ID, NEW_OWNER_NYM_ID);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static string Instrument_GetAmount(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrument_GetAmount(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Instrument_GetTransNum(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrument_GetTransNum(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Instrument_GetValidFrom(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrument_GetValidFrom(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Instrument_GetValidTo(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrument_GetValidTo(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Instrument_GetMemo(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrument_GetMemo(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Instrument_GetType(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrument_GetType(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Instrument_GetAssetID(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrument_GetAssetID(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Instrmnt_GetSenderUserID(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrmnt_GetSenderUserID(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Instrmnt_GetSenderAcctID(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrmnt_GetSenderAcctID(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Instrmnt_GetRecipientUserID(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrmnt_GetRecipientUserID(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public static string Instrmnt_GetRecipientAcctID(string SERVER_ID, string THE_INSTRUMENT) {
    string ret = otapiPINVOKE.OTAPI_Basic_Instrmnt_GetRecipientAcctID(SERVER_ID, THE_INSTRUMENT);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static int issueMarketOffer(string SERVER_ID, string USER_ID, string ASSET_TYPE_ID, string ASSET_ACCT_ID, string CURRENCY_TYPE_ID, string CURRENCY_ACCT_ID, string MARKET_SCALE, string MINIMUM_INCREMENT, string TOTAL_ASSETS_ON_OFFER, string PRICE_LIMIT, bool bBuyingOrSelling) {
    int ret = otapiPINVOKE.OTAPI_Basic_issueMarketOffer(SERVER_ID, USER_ID, ASSET_TYPE_ID, ASSET_ACCT_ID, CURRENCY_TYPE_ID, CURRENCY_ACCT_ID, MARKET_SCALE, MINIMUM_INCREMENT, TOTAL_ASSETS_ON_OFFER, PRICE_LIMIT, bBuyingOrSelling);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public static string Message_GetDepth(string THE_MESSAGE) {
    string ret = otapiPINVOKE.OTAPI_Basic_Message_GetDepth(THE_MESSAGE);
    if (otapiPINVOKE.SWIGPendingException.Pending) throw otapiPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
