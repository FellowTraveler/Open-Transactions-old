...
class OTAPI_Basic(_object):
    ...
    __swig_getmethods__["Ledger_GetTransactionNumberByIndex"] = lambda x: _otapi.OTAPI_Basic_Ledger_GetTransactionNumberByIndex
    if _newclass:Ledger_GetTransactionNumberByIndex = staticmethod(_otapi.OTAPI_Basic_Ledger_GetTransactionNumberByIndex)
    ...
    __swig_getmethods__["Instrument_GetAmount"] = lambda x: _otapi.OTAPI_Basic_Instrument_GetAmount
    if _newclass:Instrument_GetAmount = staticmethod(_otapi.OTAPI_Basic_Instrument_GetAmount)
    __swig_getmethods__["Instrument_GetTransNum"] = lambda x: _otapi.OTAPI_Basic_Instrument_GetTransNum
    if _newclass:Instrument_GetTransNum = staticmethod(_otapi.OTAPI_Basic_Instrument_GetTransNum)
    __swig_getmethods__["Instrument_GetValidFrom"] = lambda x: _otapi.OTAPI_Basic_Instrument_GetValidFrom
    if _newclass:Instrument_GetValidFrom = staticmethod(_otapi.OTAPI_Basic_Instrument_GetValidFrom)
    __swig_getmethods__["Instrument_GetValidTo"] = lambda x: _otapi.OTAPI_Basic_Instrument_GetValidTo
    if _newclass:Instrument_GetValidTo = staticmethod(_otapi.OTAPI_Basic_Instrument_GetValidTo)
    __swig_getmethods__["Instrument_GetMemo"] = lambda x: _otapi.OTAPI_Basic_Instrument_GetMemo
    if _newclass:Instrument_GetMemo = staticmethod(_otapi.OTAPI_Basic_Instrument_GetMemo)
    __swig_getmethods__["Instrument_GetType"] = lambda x: _otapi.OTAPI_Basic_Instrument_GetType
    if _newclass:Instrument_GetType = staticmethod(_otapi.OTAPI_Basic_Instrument_GetType)
    __swig_getmethods__["Instrument_GetAssetID"] = lambda x: _otapi.OTAPI_Basic_Instrument_GetAssetID
    if _newclass:Instrument_GetAssetID = staticmethod(_otapi.OTAPI_Basic_Instrument_GetAssetID)
...
def OTAPI_Basic_Ledger_GetTransactionNumberByIndex(*args):
  return _otapi.OTAPI_Basic_Ledger_GetTransactionNumberByIndex(*args)
OTAPI_Basic_Ledger_GetTransactionNumberByIndex = _otapi.OTAPI_Basic_Ledger_GetTransactionNumberByIndex
...
def OTAPI_Basic_Instrument_GetAmount(*args):
  return _otapi.OTAPI_Basic_Instrument_GetAmount(*args)
OTAPI_Basic_Instrument_GetAmount = _otapi.OTAPI_Basic_Instrument_GetAmount

def OTAPI_Basic_Instrument_GetTransNum(*args):
  return _otapi.OTAPI_Basic_Instrument_GetTransNum(*args)
OTAPI_Basic_Instrument_GetTransNum = _otapi.OTAPI_Basic_Instrument_GetTransNum

def OTAPI_Basic_Instrument_GetValidFrom(*args):
  return _otapi.OTAPI_Basic_Instrument_GetValidFrom(*args)
OTAPI_Basic_Instrument_GetValidFrom = _otapi.OTAPI_Basic_Instrument_GetValidFrom

def OTAPI_Basic_Instrument_GetValidTo(*args):
  return _otapi.OTAPI_Basic_Instrument_GetValidTo(*args)
OTAPI_Basic_Instrument_GetValidTo = _otapi.OTAPI_Basic_Instrument_GetValidTo

def OTAPI_Basic_Instrument_GetMemo(*args):
  return _otapi.OTAPI_Basic_Instrument_GetMemo(*args)
OTAPI_Basic_Instrument_GetMemo = _otapi.OTAPI_Basic_Instrument_GetMemo

def OTAPI_Basic_Instrument_GetType(*args):
  return _otapi.OTAPI_Basic_Instrument_GetType(*args)
OTAPI_Basic_Instrument_GetType = _otapi.OTAPI_Basic_Instrument_GetType

def OTAPI_Basic_Instrument_GetAssetID(*args):
  return _otapi.OTAPI_Basic_Instrument_GetAssetID(*args)
OTAPI_Basic_Instrument_GetAssetID = _otapi.OTAPI_Basic_Instrument_GetAssetID
