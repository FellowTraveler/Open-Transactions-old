...
SWIGEXPORT jboolean JNICALL Java_com_wrapper_core_jni_otapiJNI_OTAPI_1Basic_1ClearRecord(JNIEnv *jenv, jclass jcls, jstring jarg1, jstring jarg2, jstring jarg3, jint jarg4, jboolean jarg5) {
  jboolean jresult = 0 ;
  std::string *arg1 = 0 ;
  std::string *arg2 = 0 ;
  std::string *arg3 = 0 ;
