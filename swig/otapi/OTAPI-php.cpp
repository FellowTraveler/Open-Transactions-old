...
ZEND_NAMED_FUNCTION(_wrap_OTPasswordData_setUsingOldSystem__SWIG_0) {
  ...
  /*@SWIG:/usr/local/Cellar/swig/2.0.6/share/swig/2.0.6/php/utils.i,2,CONVERT_BOOL_IN@*/
...
ZEND_NAMED_FUNCTION(_wrap_OTPassword_setPassword) {
  ...
  /*@SWIG:/usr/local/Cellar/swig/2.0.6/share/swig/2.0.6/php/utils.i,7,CONVERT_INT_IN@*/
